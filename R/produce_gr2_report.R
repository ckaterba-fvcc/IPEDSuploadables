...
produce_gr2_report <- function(df, part = "ALL", format = "uploadable", ugender = lifecycle::deprecated()) {

  stopifnot(toupper(part) %in% c("B", "C", "D", "ALL"),
  ...
  } else if(toupper(part) %in% c("B", "C", "D")) {
